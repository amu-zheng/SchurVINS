...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/tmp/tmp.EjzChWJKnL/svo_ros/include".split(';') if "/tmp/tmp.EjzChWJKnL/svo_ros/include" != "" else []
...
PROJECT_SPACE_DIR = "/tmp/tmp.EjzChWJKnL/svo_ros/cmake-build-debug-remote-host/devel"
